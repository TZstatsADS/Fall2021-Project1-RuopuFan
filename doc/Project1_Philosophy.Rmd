...
In this project, I'm going to explore the texts by main philosophers in the modern era. Through this analysis, we can observe the way that the thinkers organized their thoughts in texts and the disparities among different schools and authors.

# An overall glimpse of the texts
...
# A closer look at Rationalism, Empiricism & German Idealism

Here, we are going to explore further and see if the three schools share similar wording habits.
...
In German Idealism, we perceive properties of an object by its appearance but cannot know the "thing-in-itself". The word cloud also indicates that it is the `cognition`, `consciousness` or `intuition` that helps us build `determination` through what we can see, yet we are not able to know the reality directly. The `concept` in one's mind may or may not be true.

# The main thinker: Immanuel Kant
